...
@section('content')
    <div class="container-fluid">
        <div class="row justify-content-center">
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header" hidden style="color:#4267b2; font-weight: bolder ">{{ __('Department') }}</div>
                                            ...
                                            <tr>
                                              ...
                                              <td>
                                                  ...
                                                  <div class="dropdown-menu dropdown-menu action" aria-labelledby="admins" id="action">
                                                      ...
                                                      {!! Form::open(['method'=>'DELETE','action'=>['DepartmentController@destroy',$item->id],'onsubmit'=>"return confirm('Are you sure you want to post');"],['class'=>'form-inline'])!!}
                            ...
                            <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
                                <div class="modal-content" style="background-color:#4267b2; color: #fff; font-family: San Francisco ;">
                                    ...
                                    <div class="modal-body">
                                        {!! Form::open(['method'=>'POST','action'=>'DepartmentController@store','onsubmit'=>"return confirm('Are you sure you want to post');"] ) !!}
                                        @csrf
                        ...
                        <div class="modal fade" id="addupdate" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
                            <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
                                <div class="modal-content" style="background-color:#4267b2; color: #fff; font-family: San Francisco ;">
                                    ...
                                    <div class="modal-body">
                                        {!! Form::open(['method'=>'PUT','action'=>['DepartmentController@update','updating...'],'onsubmit'=>"return confirm('Are you sure you want to post');"] ) !!}
                                        @csrf
